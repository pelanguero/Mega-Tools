...
public class Paxel extends MiningToolItem {
    ...
    public int rango;
    public Paxel(ToolMaterial tier, int attackDamageIn, float attackSpeedIn, Settings builder, int prango ) {
    ...
    static {
        EFFECTIVE_MATERIALS = Sets.newHashSet(new Material[]{Material.SHULKER_BOX, Material.METAL, Material.STONE, Material.DENSE_ICE,Material.SNOW_BLOCK,Material.SOIL,Material.SNOW_LAYER});
