...
public class VoidHammer extends PickaxeItem {
    private static final Set<Block> EFFECTIVE_BLOCKS;
    private static final Set<Material> EFFECTIVE_MATERIALS;
    public int rango;
    public VoidHammer(ToolMaterial tier, int attackDamageIn, float attackSpeedIn, Item.Settings builder, int prango ) {
    ...
    static {
        EFFECTIVE_MATERIALS = Sets.newHashSet(new Material[]{Material.SHULKER_BOX, Material.METAL, Material.STONE, Material.DENSE_ICE});
